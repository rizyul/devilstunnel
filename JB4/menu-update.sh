...
BURIQ () {
    curl -sS https://raw.githubusercontent.com/rizyul/regis/main/Ip  > /root/tmp
...
Name=$(curl -sS https://raw.githubusercontent.com/rizyul/regis/main/Ip  | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/rizyul/regis/main/Ip  | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
ver=$( curl sS https://raw.githubusercontent.com/rizyul/devilstunnel/main/versi  )
clear
# CEK UPDATE
...
version=$(cat /home/ver)
new_version=$( curl sS https://raw.githubusercontent.com/rizyul/devilstunnel/main/versi | grep $version )
#Status Version
